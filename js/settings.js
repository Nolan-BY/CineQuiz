...
function formSend(form) {
    turnsNumber = document.getElementById("turns-number").value;
    timeByTurn = document.getElementById("turns-time").value;
    penalties = document.querySelector("input[name='penalties-check']:checked").value;
    genre = document.getElementById("genre-select").value;
    playerMode = document.querySelector("input[name='player-mode']:checked").value;
    gameMode = document.getElementById("type-select").value;

    localStorage.setItem('gameMode', JSON.stringify(gameMode));
    localStorage.setItem('playerMode', JSON.stringify(playerMode));
    localStorage.setItem('turnsNumber', JSON.stringify(turnsNumber));
    localStorage.setItem('timeByTurn', JSON.stringify(timeByTurn));
